 ...
 * @author Jean
 */
public class jifFormTuristicoProblema extends javax.swing.JInternalFrame {
     ...
     */
    ModeloTabelaRelatorios modeloTabelaTuristico = new ModeloTabelaRelatorios();
    ...
    public jifFormTuristicoProblema() {
        initComponents();
    ...
    public void buscarRelatoriosTabela() {
        ...
        listaOriginalTemporariaRelatorio = modeloTabelaTuristico.retornaListaRelatorioPrincipal();
    ...
    public RelatorioPrincipal preencherDadosCadastroTuristico() {
        ...
        if (rbInseridoEmAreaResidencial.isSelected()) {
            turisticoCadastro.setRELATORIO_INSERIDO_EM_AREA(1);
        }
        if (rbInseridoEmAreaComercial.isSelected()) {
            turisticoCadastro.setRELATORIO_INSERIDO_EM_AREA(2);
        }
        if (rbInseridoEmAreaMista.isSelected()) {
            turisticoCadastro.setRELATORIO_INSERIDO_EM_AREA(3);
        }
        if (rbInseridoEmAreaOutra.isSelected()) {
            turisticoCadastro.setRELATORIO_INSERIDO_EM_AREA(4);
        }
        turisticoCadastro.setRELATORIO_INSERIDO_EM_AREA_OUTRA_ESPECIFICAR(tfInseridoEmAreaOutraEspecificar.getText());
        //turisticoCadastro.setRELATORIO_LOCALIZACAO_LEI();
        //turisticoCadastro.setRELATORIO_LOCALIZACAO_PLANO();
        ...
        if (rbAreaDaUcNao.isSelected()) {
            turisticoCadastro.setRELATORIO_AREA_DA_UC(0);
        }
        turisticoCadastro.setRELATORIO_AREA_DA_UC_NOME(tfAreaDaUcNome.getText());
        //turisticoCadastro.setRELATORIO_AREA_DA_UC_ADMINISTRADOR();
        turisticoCadastro.setRELATORIO_AREA_DA_UC_N_DOCUMENTO(tfAreaDaUcNDocumento.getText());
        //turisticoCadastro.setRELATORIO_HA_PATRIMONIO();
        //turisticoCadastro.setRELATORIO_N_IPHAN();
        if (rbSuprecaoVegetacaoSim.isSelected()) {
            turisticoCadastro.setRELATORIO_SUPRECAO_VEGETACAO(1);
        }
        if (rbSuprecaoVegetacaoNao.isSelected()) {
            turisticoCadastro.setRELATORIO_SUPRECAO_VEGETACAO(0);
        }
        turisticoCadastro.setRELATORIO_SUPRECAO_VEGETACAO_DOCUMENTO_IDAF(tfSuprecaoVegetacaoDocumentoIdaf.getText());
        //turisticoCadastro.setRELATORIO_LOTE_DE_MENOR_AREA();
        //turisticoCadastro.setRELATORIO_CONDICOES_DO_TERRENO();
        //turisticoCadastro.setRELATORIO_CONDICOES_DO_TERRENO_OPCOES();
        //turisticoCadastro.setRELATORIO_CONDICOES_DO_TERRENO_ESPECIFICAR();
        ...
        if (rbISAInstalacao.isSelected()) {
            turisticoCadastro.setRELATORIO_INFORMACOES_SOBRE_A_ATIVIDADE(1);
        }
        if (rbISAOperacao.isSelected()) {
            turisticoCadastro.setRELATORIO_INFORMACOES_SOBRE_A_ATIVIDADE(2);
        }
        Calendar calISA = Calendar.getInstance();
        calISA.setTime((Date) dataISA.getValue());
        turisticoCadastro.setRELATORIO_I_S_A_DATA(calISA);
        turisticoCadastro.setRELATORIO_I_S_A_PREVISAO_OPERACAO(tfISAPrevisaoVegetacao.getText());
        turisticoCadastro.setRELATORIO_I_S_A_N_EMPREGADOS(tfNEmpregados.getText());
        //turisticoCadastro.setRELATORIO_I_S_A_AREA_TOTAL_MOVIMENTACAO_TERRA();
        //turisticoCadastro.setRELATORIO_I_S_A_AREA_DE_CORTE();
        //turisticoCadastro.setRELATORIO_I_S_A_AREA_DE_ATERRO();
        //turisticoCadastro.setRELATORIO_I_S_A_TALUDES_FORMADOS();
        //turisticoCadastro.setRELATORIO_RECURSOS_HIDRICOS_1();
        //turisticoCadastro.setRELATORIO_R_H_NOME_1();
        //turisticoCadastro.setRELATORIO_R_H_DISTANCIA_1();
        //turisticoCadastro.setRELATORIO_BOTA_FORA();
        //turisticoCadastro.setRELATORIO_BOTA_FORA_UTM_N();
        //turisticoCadastro.setRELATORIO_BOTA_FORA_UTM_E();
        //turisticoCadastro.setRELATORIO_BOTA_FORA_OPCAO_1();
        //turisticoCadastro.setRELATORIO_BOTA_FORA_OPCAO_2();
        //turisticoCadastro.setRELATORIO_BOTA_FORA_N_DA_UC();
        //turisticoCadastro.setRELATORIO_RECURSOS_HIDRICOS_2();
        //turisticoCadastro.setRELATORIO_R_H_NOME_2();
        //turisticoCadastro.setRELATORIO_R_H_DISTANCIA_2();
        //turisticoCadastro.setRELATORIO_COMPLEMENTACAO_DO_SERVICO_TERRAPLANAGEM();
        //turisticoCadastro.setRELATORIO_C_S_T_UTM_N();
        //turisticoCadastro.setRELATORIO_C_S_T_UTM_E();
        //turisticoCadastro.setRELATORIO_C_S_T_AREA_EMPRESTIMO();
        //turisticoCadastro.setRELATORIO_C_S_T_OPCAO_1();
        //turisticoCadastro.setRELATORIO_C_S_T_OPCAO_2();
        //turisticoCadastro.setRELATORIO_C_S_T_N_DA_UC();
        //turisticoCadastro.setRELATORIO_RECURSOS_HIDRICOS_3();
        //turisticoCadastro.setRELATORIO_R_H_NOME_3();
        //turisticoCadastro.setRELATORIO_R_H_DISTANCIA_3();
        ...
        turisticoCadastro.setRELATORIO_F_A_A_POCO_TIPO(tfFAAPocoTipo.getText());
        turisticoCadastro.setRELATORIO_F_A_A_POCO_QTD(tfFAAPocoQtd.getText());
        turisticoCadastro.setRELATORIO_F_A_A_NUMERO_LICENCA(tfFAANumeroLicenca.getText());
        turisticoCadastro.setRELATORIO_F_A_A_CURSO_DAGUA_NOME(tfFAACursoDaguaNome.getText());
        turisticoCadastro.setRELATORIO_F_A_A_LAGO_NOME(tfFAALagoNome.getText());
        turisticoCadastro.setRELATORIO_F_A_A_AGUAS_COSTEIRAS_ESPECIFICAR(tfFAAAguasCosteirasEspecificar.getText());
        turisticoCadastro.setRELATORIO_F_A_A_OUTRAS_ESPECIFICAR(tfFAAOutrasEspecificar.getText());
        turisticoCadastro.setRELATORIO_F_A_A_CONSUMO_DE_AGUA(tfFAAConsumoDeAgua.getText());
        turisticoCadastro.setRELATORIO_F_A_A_N_DOCUMENTO_OUTORGA_R_H(tfFAANDocumentoOutorgaRh.getText());
        turisticoCadastro.setRELATORIO_F_A_A_N_DOCUMENTO_CERTIDAO_D_O(tfFAANDocumentoCertidaoDo.getText());
        ...
        turisticoCadastro.setRELATORIO_FONTES_DE_GERACAO_EFLUENTES(CheckBoxFGE);
        //turisticoCadastro.setRELATORIO_MOVIMENTACAO_DE_TERRA();
        turisticoCadastro.setRELATORIO_F_G_E_OUTRO_ESPECIFICAR_1(tfFGEEspecificar1.getText());
        turisticoCadastro.setRELATORIO_F_G_E_OUTRO_ESPECIFICAR_2(tfFGEEspecificar2.getText());
        if (ckbMSTSemestral.isSelected()) {
            turisticoCadastro.setRELATORIO_MANUTENCAO_DO_SISTEMA_DE_TRATAMENTO(ckbMSTSemestral.getText());
        }
        if (ckbMSTAnual.isSelected()) {
            turisticoCadastro.setRELATORIO_MANUTENCAO_DO_SISTEMA_DE_TRATAMENTO(ckbMSTAnual.getText());
        }
        if (ckbMSTOutroPeriodoManutencao1.isSelected()) {
            turisticoCadastro.setRELATORIO_MANUTENCAO_DO_SISTEMA_DE_TRATAMENTO(ckbMSTOutroPeriodoManutencao1.getText());
        }
        if (ckbMSTNaoRealiza.isSelected()) {
            turisticoCadastro.setRELATORIO_MANUTENCAO_DO_SISTEMA_DE_TRATAMENTO(ckbMSTNaoRealiza.getText());
        }
        if (ckbMSTSemanal.isSelected()) {
            turisticoCadastro.setRELATORIO_M_S_T_CAIXA_DE_GORDURA(ckbMSTSemanal.getText());
        }
        if (ckbMSTMensal.isSelected()) {
            turisticoCadastro.setRELATORIO_M_S_T_CAIXA_DE_GORDURA(ckbMSTMensal.getText());
        }
        if (ckbMSTOutroPeriodoManutencao2.isSelected()) {
            turisticoCadastro.setRELATORIO_M_S_T_CAIXA_DE_GORDURA(ckbMSTOutroPeriodoManutencao2.getText());
        }
        turisticoCadastro.setRELATORIO_M_S_T_ESPECIFICAR(tfMSTEspecificar1.getText());
        turisticoCadastro.setRELATORIO_M_S_T_CAIXA_DE_GORDURA_ESPECIFICAR(tfMSTEspecificar2.getText());
        ...
        turisticoCadastro.setRELATORIO_G_R_NUMERO_LICENCA_1(tfGRNumeroLicenca1.getText());
        turisticoCadastro.setRELATORIO_G_R_NUMERO_LICENCA_2(tfGRNumeroLicenca2.getText());
        turisticoCadastro.setRELATORIO_G_R_NUMERO_LICENCA_3(tfGRNumeroLicenca3.getText());
        //turisticoCadastro.setRELATORIO_G_R_CONSUMEO_DE_AGUA_L_DIA();
        //turisticoCadastro.setRELATORIO_G_R_CONSUMEO_DE_AGUA_M_MES();
        //turisticoCadastro.setRELATORIO_EMISSOES_ATMOSFERICAS();
        //turisticoCadastro.setRELATORIO_E_A_ESPECIFICAR();
        turisticoCadastro.setRELATORIO_ROTEIRO_DE_ACESSO(taRoteiroAcesso.getText());
        //turisticoCadastro.setRELATORIO_CROQUI_DE_LOCALIZACAO_EMPREENDIMENTO();
        if (rbCLENadamaisexisteadeclarar.isSelected()) {
            turisticoCadastro.setRELATORIO_CROQUI_PERGUNTA(0);
        }
        if (rbCLEDeclaramosoqueconstaemanexo.isSelected()) {
            turisticoCadastro.setRELATORIO_CROQUI_PERGUNTA(1);
        }
        turisticoCadastro.setRELATORIO_TEXTO_ANEXO(taTextoAnexo.getText());
        Calendar cal = Calendar.getInstance();
        ...
        if (imagem != null) {
            try {
                ...
                turisticoCadastro.setRELATORIO_CROQUI_DE_LOCALIZACAO_EMPREENDIMENTO(outputfile.getName());
...
//        tfDataAtual.setText("");
        ...
        tpnAbasTuristico.setSelectedIndex(1); // Mudando para a PRIMEIRA aba

        tpnAbasTuristico.setTitleAt(0, "Cadastrar Novo Turístico");
        btFinalizarCadastro.setToolTipText("Cadastrar");
        tpnAbasTuristico.setEnabledAt(1, true);
        tpnAbasTuristico.setSelectedIndex(1);
    ...
    private void initComponents() {
        ...
        tpnAbasTuristico = new javax.swing.JTabbedPane();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Empreendimentos Desportivos");
        setPreferredSize(new java.awt.Dimension(938, 633));

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPane1.setPreferredSize(new java.awt.Dimension(873, 4449));

        pnRestaurante.setPreferredSize(new java.awt.Dimension(871, 4447));
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(tfAreaDaUcNome, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        ckbFAAReutilizacao.setText("Não se aplica.Reutilização de água do processo produtivo");
        ...
        ckbGRNaohaGeracao3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ckbGRNaohaGeracao3ActionPerformed(evt);
            }
        });
        ...
        jPanel24Layout.setVerticalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                ...
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel70)
                    .addComponent(tfAreaCoberta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel71)
                    .addComponent(tfAreaDescoberta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        pnRestauranteLayout.setHorizontalGroup(
            ...
            .addGroup(pnRestauranteLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnRestauranteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnRestauranteLayout.createSequentialGroup()
                        .addGroup(pnRestauranteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        tpnAbasTuristico.addTab("Cadastrar Novos Turísticos", jScrollPane1);

        jPanel23.setPreferredSize(new java.awt.Dimension(927, 567));
        ...
        jPanel33.setPreferredSize(new java.awt.Dimension(903, 110));
        ...
        jPanel23Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel23Layout.createSequentialGroup()
                ...
                .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel33, javax.swing.GroupLayout.DEFAULT_SIZE, 893, Short.MAX_VALUE)
        ...
        tpnAbasTuristico.addTab("Gerenciar Turísticos", jPanel23);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tpnAbasTuristico, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 890, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tpnAbasTuristico, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 597, Short.MAX_VALUE)
        );
    ...
    private void ckbGRNaohaGeracao3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckbGRNaohaGeracao3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ckbGRNaohaGeracao3ActionPerformed
    ...
    private void tfPalavraChaveTuristicoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfPalavraChaveTuristicoKeyReleased
        ...
        if (tfPalavraChaveTuristico.getText().isEmpty()) {
            ...
            if (ckbCliente.isSelected()) {
                for (int i = 0; i < modeloTabelaTuristico.retornaListaRelatorioPrincipal().size(); i++) {
                    if (modeloTabelaTuristico.retornaListaRelatorioPrincipal().get(i).getCLIENTE_NOME().toLowerCase().contains(tfPalavraChaveTuristico.getText().toLowerCase())) {
                        listaOriginalTemporariaRelatorio.add(modeloTabelaTuristico.retornaListaRelatorioPrincipal().get(i));
                    }
                }
            } else if (ckbProfissional.isSelected()) {
                for (int i = 0; i < modeloTabelaTuristico.retornaListaRelatorioPrincipal().size(); i++) {
                    if (modeloTabelaTuristico.retornaListaRelatorioPrincipal().get(i).getPROFISSIONAL_NOME().toLowerCase().contains(tfPalavraChaveTuristico.getText().toLowerCase())) {
                        listaOriginalTemporariaRelatorio.add(modeloTabelaTuristico.retornaListaRelatorioPrincipal().get(i));
                    }
                }
            }

            modeloTabelaTuristico.inserirListaRelatorioPrincipal(listaOriginalTemporariaRelatorio);
    ...
    private void btCancelarAtualizacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarAtualizacaoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(rootPane, "Deseja mesmo cancelar as alterações", "Aviso", 0) == 0) {
            btFinalizarCadastro.setToolTipText("Cadastrar");
            tpnAbasTuristico.setSelectedIndex(1); // Mudando para a PRIMEIRA aba
            tpnAbasTuristico.setTitleAt(0, "Cadastrar Relatório Turístico");
            btFinalizarCadastro.setToolTipText("Cadastrar");
            tpnAbasTuristico.setEnabledAt(1, true);
            btCancelarAtualizacao.setVisible(false);
            tfNomeCliente.setText("");
    ...
    private void btFinalizarCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFinalizarCadastroActionPerformed
        if (tfNomeCliente.getText().isEmpty()) {
            JOptionPane.showMessageDialog(tpnAbasTuristico, "Por favor escolha o cliente", "Aviso", 2);
    ...
    private void btEditarProfissionalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarProfissionalActionPerformed
        ...
        if (tbRelatoriosCadastrados.getSelectedRow() == -1) {
            ...
            RelatorioPrincipal relatorioPrincipal = modeloTabelaTuristico.retornaListaRelatorioPrincipal().get(tbRelatoriosCadastrados.getSelectedRow());
            ...
            tpnAbasTuristico.setTitleAt(0, "Atualizar dados");
            tpnAbasTuristico.setEnabledAt(1, false);
    ...
    private void rbInseridoEmAreaMistaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rbInseridoEmAreaMistaMouseClicked
        ...
        rbInseridoEmAreaComercial.setSelected(false);
        rbInseridoEmAreaIndustrial.setSelected(false);
        rbInseridoEmAreaOutra.setSelected(false);        // TODO add your handling code here:
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        if (tbRelatoriosCadastrados.getSelectedRow() == -1) {
            ...
            try {
                ...
                filtro.put("id", turistico.getRELATORIO_ID());
                filtro.put("data", data);
                //Usando a classe JasperPrint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("build/classes/reports/Turistico.jasper", filtro, conexao);
